...
public class CredentialController {
    ...
    static {
        STATUS.put("backend-ms-b", "Em Execução");
        STATUS.put("backend-ms-a", "Desconhecido");
    ...
    public Map<String, String> atualizarStatus() {
        ...
        try {
            // A verificação de backend-a já implica que a comunicação mTLS deve estar correta
            URL url = new URL("https://backend-a:8443/backend-a/status");
